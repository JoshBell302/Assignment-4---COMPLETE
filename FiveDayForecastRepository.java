...
import com.example.android.sqliteweather.RecentSearchesViewModel;
...
public class FiveDayForecastRepository {
    ...
    public void loadForecast(String location, String units, String apiKey, RecentSearchesViewModel rsvm) {
        if (shouldFetchForecast(location, units)) {
            int time = (int) System.currentTimeMillis();
            ForecastCity forecastCity = new ForecastCity(location,0,0,0,time);
            ...
            rsvm.insertFiveDayForecast(forecastCity);
